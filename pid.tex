...
\DeclareUnicodeCharacter{202F}{} %fixes unicode 202F error
\usepackage{amsmath}
\usepackage{graphicx}
...
\usepackage{xcolor} % RISK ANALYSIS TABLE
...
RISK                           & AREAS AFFECTED                                                             & SEVERITY                                                                                   & LIKELIHOOD                       & RISK IMPACT                    & \begin{tabular}[c]{@{}l@{}}RECOMMENDED\\   ACTION(S)\end{tabular}                                                                                              \\
Sensor defects                 & Functionality of the robot                                                 & \cellcolor[HTML]{FFC702}Tolerable                                                          & \cellcolor[HTML]{FFCB2F}Possible & \cellcolor[HTML]{FFC702}Medium & \begin{tabular}[c]{@{}l@{}}Proper\\   calibration of sensors\end{tabular}                                                                                      \\
Robot breakdown                & \begin{tabular}[c]{@{}l@{}}Transmission of\\   fluids\end{tabular}         & \cellcolor[HTML]{F56B00}\begin{tabular}[c]{@{}l@{}}Generally\\   unacceptable\end{tabular} & \cellcolor[HTML]{FFCB2F}Possible & \cellcolor[HTML]{F56B00}High   & \begin{tabular}[c]{@{}l@{}}Sectional inspection and checklists on pre-inspection explaining\\   the necessities for an inspection session\end{tabular}         \\
Failure to detect minute holes & Functionality of the robot                                                 & \cellcolor[HTML]{FFC702}Tolerable                                                          & \cellcolor[HTML]{FFCB2F}Possible & \cellcolor[HTML]{F56B00}High   & Resolving sensor defects mitigates this risk                                                                                                                   \\
Communication failure          & \begin{tabular}[c]{@{}l@{}}Functionality\\   of the robot\end{tabular}     & \cellcolor[HTML]{F56B00}\begin{tabular}[c]{@{}l@{}}Generally\\   unacceptable\end{tabular} & \cellcolor[HTML]{FFCB2F}Possible & \cellcolor[HTML]{F56B00}High   & Some level of autonomity helps in mitigating this risk                                                                                                         \\
Gas leak into robot's hull     & Functionality of the robot                                                 & \cellcolor[HTML]{FFC702}Tolerable                                                          & \cellcolor[HTML]{FFCB2F}Possible & \cellcolor[HTML]{F56B00}High   & \begin{tabular}[c]{@{}l@{}}Some level of autonomity helps in mitigating this risk/ Building\\   the hull to handle 5x pressure than normal level.\end{tabular} \\
Electrical discharge           & \begin{tabular}[c]{@{}l@{}}Inspection area\\   and pipelines\end{tabular}  & \cellcolor[HTML]{F56B00}\begin{tabular}[c]{@{}l@{}}Generally\\   unacceptable\end{tabular} & \cellcolor[HTML]{F56B00}probable & \cellcolor[HTML]{F56B00}High   & Proper insulation of electronic sensors and actuators                                                                                                          \\
Failure in tracking            & Functionality of the robot                                                 & \cellcolor[HTML]{FFC702}Tolerable                                                          & \cellcolor[HTML]{FFCB2F}Possible & \cellcolor[HTML]{F56B00}High   & Initial tests help reduce this risk but not completely avoidable                                                                                               \\
Insufficient funds             & \begin{tabular}[c]{@{}l@{}}Development of\\   proper solution\end{tabular} & \cellcolor[HTML]{FFC702}Tolerable                                                          & \cellcolor[HTML]{FFCB2F}Possible & \cellcolor[HTML]{F56B00}High   & \begin{tabular}[c]{@{}l@{}}Improving funds significantly improves in mitigating the above\\   risks\end{tabular}         \end{tabular}
\end{adjustbox}
\end{table}
